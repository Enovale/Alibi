...
{
    public sealed class WebhookPlugin : Plugin
    {
        ...
        public WebhookPlugin(IServer server, IPluginManager pluginManager) : base(server, pluginManager)
        {
            ...
            _hook = new DiscordWebhook(Configuration.WebhookUrl)
            {
